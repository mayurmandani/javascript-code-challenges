/* You are given an array of objects, where each object represents a user with a name and a score. 
    Your task is to complete the getUsersByScore function. 
...
const data = [
  ...
  function getUsersByScore(data, scoreAbove) {
    let filterData = data.filter((data) => data.score > scoreAbove);
    return filterData;
  }
